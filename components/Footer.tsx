      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-16 mb-24">
          <div className="space-y-8">
            ...
            <div className="flex gap-4">
              {['logo-linkedin', 'logo-instagram', 'logo-twitter'].map((icon) => (
                <a key={icon} href="#" className="w-10 h-10 bg-white/50 border border-zinc-200/50 flex items-center justify-center rounded-lg text-zinc-400 hover:text-[#B8860B] hover:border-[#B8860B] transition-all">
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4 text-zinc-600 text-sm font-medium">
        ...
        <div className="border-t border-zinc-200/50 pt-10 flex flex-col md:flex-row justify-between items-center gap-6 text-[11px] font-bold uppercase tracking-[0.2em] text-zinc-400">
