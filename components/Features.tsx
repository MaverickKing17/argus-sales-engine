...
const Features: React.FC = () => {
  return (
    <section id="technology" className="relative py-32 overflow-hidden bg-[#fafafa]">
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {[
            ...
            <div key={i} className="bg-white p-12 group border border-zinc-100 shadow-sm hover:shadow-xl hover:border-[#B8860B]/20 transition-all duration-500 rounded-2xl">
              <div className="w-16 h-16 bg-zinc-50 border border-zinc-100 flex items-center justify-center mb-8 rounded-xl group-hover:scale-110 transition-transform">
      ...
      <div className="mt-32 max-w-7xl mx-auto px-6">
        <img 
          ...
          alt="Luxury Interior" 
          className="w-full h-[500px] object-cover rounded-3xl shadow-2xl brightness-110"
        />
      </div>
    </section>
  );
